...
- [~] **Fase 6**: Tailscale / redes remotas — unirse al coordinador por IP en vez de mDNS (`start_joining`/`connect_to_coordinator`); modo DJ con mezcla de múltiples fuentes pendiente
